  ...
  switch (Layer::curr) {
    case Layer::latin: {
      switch (currc) {
        ...
        case 0b10000000011: {
            modif.start_quazi(Mod::ctrl, Layer::curr);
            break;
        }
        case 0b01000000011: {
            modif.start_quazi(Mod::altl, Layer::curr);
            break;
        }
        case 0b00100000011: {
            modif.start_quazi(Mod::shift, Layer::curr);
            break;
        }
        case 0b00010000011: {
            modif.start_quazi(Mod::super, Layer::curr);
            break;
        }
        case 0b00001000011: {
            Keyboard.print("a ");
